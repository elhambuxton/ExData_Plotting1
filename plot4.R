...
plot(power_df$Time,power_df$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")

plot(power_df$Time,power_df$Voltage, type="l", ylab="Voltage", xlab="datetime")


plot(power_df$Time,power_df$Sub_metering_1, type="n", ylab="Energy Sub metering", xlab="", bty="n", cex=0.5)
...
plot(power_df$Time,power_df$Global_reactive_power, type="l", ylab="Global_reactive_power", xlab="datetime")
